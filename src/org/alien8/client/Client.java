...
public class Client implements Runnable {
  ...
  public Client() {
    ...
    Entity ship = new Ship(new Position(200, 200), 0);
    // Add the first ship to the map, this will be the player for now
    model.addEntity(ship);
    Entity notPlayer = new Ship(new Position(100, 100), 0);
    ...
    if (socket == null && serverIP == null && ciss == null && cgsr == null) {
      try {
        ...
        DatagramPacket packet =
            new DatagramPacket(connectRequestByte, connectRequestByte.length, serverIP, 4446);
  ...
  public void disconnect() {
    if (socket != null && serverIP != null && ciss != null && cgsr != null) {
      try {
        ...
        DatagramPacket packet =
            new DatagramPacket(disconnectRequestByte, disconnectRequestByte.length, serverIP, 4446);
