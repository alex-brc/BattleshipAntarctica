...
public class ClientHandler extends Thread {
  ...
  public ClientHandler(DatagramSocket udpSocket, InetAddress clientIP,
      ConcurrentLinkedQueue<Entity> lastSyncedEntities) {
  ...
  private void sendGameState() {
    try {
      ...
      DatagramPacket packet =
          new DatagramPacket(differenceByte, differenceByte.length, clientIP, 4445);
   ...
   */
  public static ArrayList<EntityLite> calculateDifference(
      ConcurrentLinkedQueue<Entity> lastSyncedEntities,
            ...
            if (ce instanceof Ship) {
              ...
              if (!currentShip.equals(lastSyncedShip)) {
                difference.add(new EntityLite(currentShip.getSerial(), 0, 0,
                    ...
                    currentShip.getRearTurretDirection()));
              }
