...
public class HealthItem extends Item {
	public HealthItem() {
		...
		super(Sprite.item_health, Pickup.HEALTH_PICKUP); //TODO give it Sprite.health_item
	}
	...
	public void use() {
		if(ship == null) {
			LogManager.getInstance().log("HealthItem", LogManager.Scope.ERROR, "Something is using an item belongig to a null ship. ");
			return;
		}
