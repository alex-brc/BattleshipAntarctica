...
/**
 * This shutdown hook handles cleanly exiting after a System.exit() or unexpected closing of the
 * client.
 */
public class ClientShutdownHook extends Thread {
  ...
  public void run() {
    ...
    LogManager.getInstance().log("ClientShutdownHook", LogManager.Scope.INFO,
        "Hook performed all tasks succesfully. Cleanly exit.");
  }
}
