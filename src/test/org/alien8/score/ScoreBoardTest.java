...
public class ScoreBoardTest {
  ...
  public void testClientScoreBoard() {
    ...
    // Populate it
    Score score = new Score(new ScoreEvent(0, "test", 0, 0, 2, true));
    sb.update(score);
    score = new Score(new ScoreEvent(2, "test", 0, 0, 2, true));
    sb.update(score);
    // Check it's there
