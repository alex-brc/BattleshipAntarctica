...
public class AudioManagerTest {
  ...
  public static void setUp() {
    ...
    ClientModelManager.getInstance().setPlayer(new Ship(new Position(0, 0), 0, 0x000000));
  ...
  public void testSoundEvents() throws InterruptedException {
    ...
    AudioEvent ae2 = new AudioEvent(AudioEvent.Type.SHOOT,
        new Position(Parameters.MAX_HEARING_DISTANCE, Parameters.MAX_HEARING_DISTANCE));
    // Play it
    am.addEvent(ae2);
    am.sfxMuteToggle();
